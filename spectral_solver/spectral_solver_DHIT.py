...
folder = 'data_'+str(nx)
filename = "../data_spectral/"+folder+"/04_vorticity/w_"+str(int(0))+".csv"
np.savetxt(filename, w0, delimiter=",")
...
surf = ax.plot_surface(X, Y, w, cmap='coolwarm',vmin=-20, vmax=20,
...
fig.savefig("vorticity_3D_4.png", dpi=300, bbox_inches = 'tight')

#%%
def plot_w_ens(nx,ny,nxc):
    lx = 2.0*np.pi
    ly = 2.0*np.pi
    nx = nx
    ny = ny
    ...
    file_input = "../data_spectral/"+folder+"/04_vorticity/w_"+str(0)+".csv"
    ...
    cs = axs[0,0].contourf(x,y,w0.T, 10, cmap = 'jet', interpolation='bilinear')
    ...
    cs = axs[0,1].contourf(x,y,w2.T, 10, cmap = 'jet', interpolation='bilinear')
    ...
    cs = axs[1,0].contourf(x,y,w4.T, 10, cmap = 'jet', interpolation='bilinear')
...
#    fig.savefig("../data_spectral/"+folder+"/field_spectral.eps", bbox_inches = 'tight')
    fig.savefig("../data_spectral/"+folder+"/field_spectral1.png", bbox_inches = 'tight',dpi=300)

plot_w_ens(nx,ny,nxc)
